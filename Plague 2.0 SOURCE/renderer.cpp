...
if (showMenu)
{
	...
	colors[ImGuiCol_TextDisabled] = ImVec4(0, 0, 0, 1);
	colors[ImGuiCol_WindowBg] = ImVec4(0, 0, 0, 0.2f);
	colors[ImGuiCol_ChildBg] = ImVec4(17, 17, 17, 0.2);
	colors[ImGuiCol_PopupBg] = ImVec4(0.08f, 0.08f, 0.08f, 0.94f);
	colors[ImGuiCol_Border] = ImVec4(0, 0, 0, 0.2f);
	colors[ImGuiCol_BorderShadow] = ImVec4(1, 1, 1, 1);
	colors[ImGuiCol_FrameBg] = ImVec4(0, 51, 102, 0.2);
	colors[ImGuiCol_FrameBgHovered] = ImVec4(0, 51, 102, 0.2);
	colors[ImGuiCol_FrameBgActive] = ImVec4(0, 0.87f, 1, 0.68f);
	colors[ImGuiCol_TitleBg] = ImVec4(102, 0, 204, 1);
	colors[ImGuiCol_TitleBgActive] = ImVec4(102, 0, 204, 1);
	colors[ImGuiCol_TitleBgCollapsed] = ImVec4(102, 0, 204, 1);
	colors[ImGuiCol_MenuBarBg] = ImVec4(102, 0, 204, 1);
	colors[ImGuiCol_ScrollbarBg] = ImVec4(102, 0, 204, 1);
	...
	colors[ImGuiCol_CheckMark] = ImVec4(204, 51, 153, 0.2);
	colors[ImGuiCol_SliderGrab] = ImVec4(204, 51, 153, 0.2);
	colors[ImGuiCol_SliderGrabActive] = ImVec4(1, 1, 1, 1);
	colors[ImGuiCol_Button] = ImVec4(51, 0, 0, 1);
	colors[ImGuiCol_ButtonHovered] = ImVec4(0, 0.83f, 1, 1);
	colors[ImGuiCol_ButtonActive] = ImVec4(102, 0, 204, 1);
	colors[ImGuiCol_Header] = ImVec4(102, 0, 204, 1);
	colors[ImGuiCol_HeaderHovered] = ImVec4(102, 0, 153, 0.2);
	colors[ImGuiCol_HeaderActive] = ImVec4(102, 0, 153, 0.2);
	colors[ImGuiCol_Separator] = ImVec4(102, 0, 153, 0.2);
	colors[ImGuiCol_SeparatorHovered] = ImVec4(102, 0, 153, 0.2);
	colors[ImGuiCol_SeparatorActive] = ImVec4(102, 0, 153, 0.2);
	...
	if (ImGui::Begin(xorstr("PLAGUE 2.0 | SEMI DETECTED"), 0, ImGuiWindowFlags_::ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_::ImGuiWindowFlags_NoResize)) {
		ImGui::SetWindowSize(ImVec2(500, 500.0f));
		...
		Style->Colors[ImGuiCol_Button] = fortnitetab == 0 ? ImColor(238, 238, 238, 0.2) : ImColor(238, 238, 238, 0.2);
		if (ImGui::Button("Visuals", ImVec2(254, 26))) fortnitetab = 1;
		Style->Colors[ImGuiCol_Button] = fortnitetab == 1 ? ImColor(238, 238, 238, 0.2) : ImColor(238, 238, 238, 0.2);
		if (ImGui::Button("Aimbot", ImVec2(254, 26))) fortnitetab = 2;
		Style->Colors[ImGuiCol_Button] = fortnitetab == 3 ? ImColor(238, 238, 238, 0.2) : ImColor(238, 238, 238, 0.2);
		if (ImGui::Button("EXPLOITS", ImVec2(254, 26))) fortnitetab = 3;

		if (fortnitetab == 2)
		{
			ImGui::SetNextWindowSize({ 272,369 });
		...
		ImGui::SetNextWindowSize({ 272,369 });
					...
					ImGui::Checkbox("Pickaxe Teleport", &Settings.killaura);
